    ...
    (function() {
      // Vars.
        var $form = document.querySelectorAll('#signup-form')[0],
            ...
            $toEmail = 'luanfonceca@gmail.com',
            $toName = 'Luan Fonseca',
            $fromEmail = document.querySelector('input[type="email"]'),
            $fromName = 'Contato Boca Comunica',
            $message = 'Você recebeu um contato através do email: "{{FROM_EMAIL}}".',
            $data,
            $feedback;
      ...
      // Message.
        ...
        $feedback._show = function(type, text) {
